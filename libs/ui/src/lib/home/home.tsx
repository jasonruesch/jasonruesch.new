export function Home() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center">
      <h1 className="max-w-screen-sm bg-gradient-to-br from-primary-500 from-30% to-secondary-500 to-70% bg-clip-text py-4 text-center text-6xl font-normal uppercase !leading-[1cap] text-transparent md:max-w-screen-md md:text-7xl dark:from-primary-400 dark:to-secondary-400">
