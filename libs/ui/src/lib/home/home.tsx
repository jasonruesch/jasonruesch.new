export function Home() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center">
      <h1 className="max-w-screen-md bg-gradient-to-br from-primary-500 from-30% to-secondary-500 to-70% bg-clip-text pb-4 text-center text-6xl uppercase !leading-[1cap] text-transparent md:text-7xl dark:from-primary-400 dark:to-secondary-400">
